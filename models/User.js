...
UserSchema.methods.comparePassword = async function (visitorPassword) {
  const isMatch = await bcrypt.compare(visitorPassword, this.password);
  return isMatch;
};
